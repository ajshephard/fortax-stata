...
sys%inctax%pa =  7.77884615384615046E+01_dp
...
sys%inctax%mma =  3.51923076923077005E+01_dp
...
sys%inctax%bands(1) =  7.88461538461537970E+01_dp
sys%inctax%bands(2) =  5.01923076923077019E+02_dp
...
sys%natins%c2floor =  6.69000000000000057E+01_dp
sys%natins%c2rate =  6.04999999999999982E+00_dp
sys%natins%ceiling =  4.65000000000000000E+02_dp
sys%natins%rates(1) =  2.00000000000000004E-02_dp
sys%natins%rates(2) =  1.00000000000000006E-01_dp
sys%natins%bands(1) =  6.20000000000000000E+01_dp
sys%natins%bands(2) =  4.65000000000000000E+02_dp
...
sys%natins%c4bands(1) =  1.34800000000000011E+02_dp
sys%natins%c4bands(2) =  4.65000000000000000E+02_dp
sys%natins%c4bands(3) =  1.00000000000000000E+06_dp
 
! chben
sys%chben%doChBen = 1
sys%chben%basic =  9.00000000000000000E+00_dp
sys%chben%kid1xtr =  2.04999999999999982E+00_dp
sys%chben%opf =  6.04999999999999982E+00_dp
...
sys%fc%adult =  4.76499999999999986E+01_dp
sys%fc%ftprem =  1.05500000000000007E+01_dp
sys%fc%hours1 =  1.60000000000000000E+01_dp
sys%fc%hours2 =  3.00000000000000000E+01_dp
sys%fc%thres =  7.71500000000000057E+01_dp
...
sys%fc%kidageu(3) = 17
sys%fc%kidageu(4) = 18
sys%fc%kidcred(1) =  1.20500000000000007E+01_dp
sys%fc%kidcred(2) =  1.99499999999999993E+01_dp
sys%fc%kidcred(3) =  2.48000000000000007E+01_dp
sys%fc%kidcred(4) =  3.47000000000000028E+01_dp
...
sys%incsup%MainCou =  7.71500000000000057E+01_dp
sys%incsup%YngCou =  5.87000000000000028E+01_dp
sys%incsup%MainLP =  4.91499999999999986E+01_dp
sys%incsup%YngLP =  2.96000000000000014E+01_dp
sys%incsup%MainSin =  4.91499999999999986E+01_dp
sys%incsup%YngSin =  3.88999999999999986E+01_dp
sys%incsup%ValFSM =  4.09999999999999964E+00_dp
...
sys%incsup%PremFam =  1.08000000000000007E+01_dp
sys%incsup%PremLP =  4.95000000000000018E+00_dp
...
sys%incsup%AddKid(1) =  1.68999999999999986E+01_dp
sys%incsup%AddKid(2) =  2.47500000000000000E+01_dp
sys%incsup%AddKid(3) =  2.96000000000000014E+01_dp
sys%incsup%AddKid(4) =  3.88999999999999986E+01_dp
 
! ctax
sys%ctax%docounciltax = 1
sys%ctax%bandD =  1.30384615384614992E+01_dp
...
sys%rebatesys%MainCou =  7.71500000000000057E+01_dp
sys%rebatesys%YngCou =  5.87000000000000028E+01_dp
sys%rebatesys%MainLP =  4.91499999999999986E+01_dp
sys%rebatesys%YngLP =  3.88999999999999986E+01_dp
sys%rebatesys%MainSin =  4.91499999999999986E+01_dp
sys%rebatesys%YngSin =  3.88999999999999986E+01_dp
...
sys%rebatesys%PremFam =  1.08000000000000007E+01_dp
...
sys%rebatesys%AddKid(1) =  1.68999999999999986E+01_dp
sys%rebatesys%AddKid(2) =  2.47500000000000000E+01_dp
sys%rebatesys%AddKid(3) =  2.96000000000000014E+01_dp
sys%rebatesys%AddKid(4) =  3.88999999999999986E+01_dp
