...
sys%inctax%pa =  6.77884615384615046E+01_dp
...
sys%inctax%bands(1) =  6.15384615384614975E+01_dp
sys%inctax%bands(2) =  4.67307692307691980E+02_dp
...
sys%natins%c2floor =  6.26899999999999977E+01_dp
sys%natins%c2rate =  5.75000000000000000E+00_dp
sys%natins%ceiling =  4.40000000000000000E+02_dp
sys%natins%rates(1) =  2.00000000000000004E-02_dp
sys%natins%rates(2) =  1.00000000000000006E-01_dp
sys%natins%bands(1) =  5.80000000000000000E+01_dp
sys%natins%bands(2) =  4.40000000000000000E+02_dp
...
sys%natins%c4bands(1) =  1.27689999999999998E+02_dp
sys%natins%c4bands(2) =  4.40000000000000000E+02_dp
sys%natins%c4bands(3) =  1.00000000000000000E+06_dp
 
! chben
sys%chben%doChBen = 1
sys%chben%basic =  8.44999999999999929E+00_dp
...
sys%fc%kidageu(3) = 17
sys%fc%kidageu(4) = 18
sys%fc%kidcred(1) =  1.14000000000000004E+01_dp
sys%fc%kidcred(2) =  1.88999999999999986E+01_dp
sys%fc%kidcred(3) =  2.34499999999999993E+01_dp
sys%fc%kidcred(4) =  3.27999999999999972E+01_dp
...
sys%incsup%MainCou =  7.30000000000000000E+01_dp
sys%incsup%YngCou =  5.55499999999999972E+01_dp
sys%incsup%MainLP =  4.65000000000000000E+01_dp
sys%incsup%YngLP =  2.80000000000000000E+01_dp
sys%incsup%MainSin =  4.65000000000000000E+01_dp
sys%incsup%YngSin =  3.67999999999999972E+01_dp
sys%incsup%ValFSM =  3.85000000000000009E+00_dp
...
sys%incsup%PremFam =  1.02500000000000000E+01_dp
...
sys%incsup%AddKid(1) =  1.59499999999999993E+01_dp
sys%incsup%AddKid(2) =  2.33999999999999986E+01_dp
sys%incsup%AddKid(3) =  2.80000000000000000E+01_dp
sys%incsup%AddKid(4) =  3.67999999999999972E+01_dp
 
! ctax
sys%ctax%docounciltax = 1
sys%ctax%bandD =  1.15000000000000000E+01_dp
...
sys%rebatesys%MainCou =  7.30000000000000000E+01_dp
sys%rebatesys%YngCou =  5.55499999999999972E+01_dp
sys%rebatesys%MainLP =  4.65000000000000000E+01_dp
sys%rebatesys%YngLP =  3.67999999999999972E+01_dp
sys%rebatesys%MainSin =  4.65000000000000000E+01_dp
sys%rebatesys%YngSin =  3.67999999999999972E+01_dp
...
sys%rebatesys%AddKid(1) =  1.59499999999999993E+01_dp
sys%rebatesys%AddKid(2) =  2.33999999999999986E+01_dp
sys%rebatesys%AddKid(3) =  2.80000000000000000E+01_dp
sys%rebatesys%AddKid(4) =  3.67999999999999972E+01_dp
