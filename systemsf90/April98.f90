...
sys%inctax%pa =  8.06730769230769056E+01_dp
...
sys%inctax%mma =  3.65384615384614975E+01_dp
...
sys%inctax%bands(1) =  8.26923076923076934E+01_dp
sys%inctax%bands(2) =  5.21153846153845961E+02_dp
...
sys%natins%c2floor =  6.90000000000000000E+01_dp
sys%natins%c2rate =  6.25000000000000000E+00_dp
sys%natins%ceiling =  4.85000000000000000E+02_dp
sys%natins%rates(1) =  2.00000000000000004E-02_dp
sys%natins%rates(2) =  1.00000000000000006E-01_dp
sys%natins%bands(1) =  6.40000000000000000E+01_dp
sys%natins%bands(2) =  4.85000000000000000E+02_dp
...
sys%natins%c4bands(1) =  1.40599999999999994E+02_dp
sys%natins%c4bands(2) =  4.85000000000000000E+02_dp
sys%natins%c4bands(3) =  1.00000000000000000E+06_dp
 
! chben
sys%chben%doChBen = 1
sys%chben%basic =  9.30000000000000071E+00_dp
sys%chben%kid1xtr =  2.14999999999999991E+00_dp
...
sys%fc%adult =  4.87999999999999972E+01_dp
sys%fc%ftprem =  1.08000000000000007E+01_dp
sys%fc%hours1 =  1.60000000000000000E+01_dp
sys%fc%hours2 =  3.00000000000000000E+01_dp
sys%fc%thres =  7.90000000000000000E+01_dp
...
sys%fc%kidageu(3) = 17
sys%fc%kidageu(4) = 18
sys%fc%kidcred(1) =  1.23499999999999996E+01_dp
sys%fc%kidcred(2) =  2.04499999999999993E+01_dp
sys%fc%kidcred(3) =  2.53999999999999986E+01_dp
sys%fc%kidcred(4) =  2.53999999999999986E+01_dp
...
sys%incsup%MainCou =  7.90000000000000000E+01_dp
sys%incsup%YngCou =  6.01000000000000014E+01_dp
sys%incsup%MainLP =  5.03500000000000014E+01_dp
sys%incsup%YngLP =  3.03000000000000007E+01_dp
sys%incsup%MainSin =  5.03500000000000014E+01_dp
sys%incsup%YngSin =  3.98500000000000014E+01_dp
sys%incsup%ValFSM =  4.25000000000000000E+00_dp
...
sys%incsup%PremFam =  1.10500000000000007E+01_dp
...
sys%incsup%AddKid(1) =  1.73000000000000007E+01_dp
sys%incsup%AddKid(2) =  2.53500000000000014E+01_dp
sys%incsup%AddKid(3) =  3.03000000000000007E+01_dp
sys%incsup%AddKid(4) =  3.03000000000000007E+01_dp
 
! ctax
sys%ctax%docounciltax = 1
sys%ctax%bandD =  1.41596153846153996E+01_dp
...
sys%rebatesys%MainCou =  7.90000000000000000E+01_dp
sys%rebatesys%YngCou =  6.01000000000000014E+01_dp
sys%rebatesys%MainLP =  5.03500000000000014E+01_dp
sys%rebatesys%YngLP =  3.98500000000000014E+01_dp
sys%rebatesys%MainSin =  5.03500000000000014E+01_dp
sys%rebatesys%YngSin =  3.98500000000000014E+01_dp
...
sys%rebatesys%PremFam =  1.10500000000000007E+01_dp
sys%rebatesys%PremLP =  1.10000000000000000E+01_dp
...
sys%rebatesys%AddKid(1) =  1.73000000000000007E+01_dp
sys%rebatesys%AddKid(2) =  2.53500000000000014E+01_dp
sys%rebatesys%AddKid(3) =  3.03000000000000007E+01_dp
sys%rebatesys%AddKid(4) =  3.03000000000000007E+01_dp
