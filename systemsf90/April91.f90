...
sys%inctax%pa =  6.33653846153845990E+01_dp
...
sys%inctax%bands(1) =  4.55769230769231001E+02_dp
...
sys%natins%c2floor =  5.57599999999999980E+01_dp
sys%natins%c2rate =  5.15000000000000036E+00_dp
sys%natins%ceiling =  3.90000000000000000E+02_dp
sys%natins%rates(1) =  2.00000000000000004E-02_dp
sys%natins%rates(2) =  8.99999999999999967E-02_dp
sys%natins%bands(1) =  5.20000000000000000E+01_dp
sys%natins%bands(2) =  3.90000000000000000E+02_dp
...
sys%natins%c4bands(1) =  1.13459999999999994E+02_dp
sys%natins%c4bands(2) =  3.90000000000000000E+02_dp
sys%natins%c4bands(3) =  1.00000000000000000E+06_dp
 
! chben
sys%chben%doChBen = 1
sys%chben%basic =  7.25000000000000000E+00_dp
sys%chben%kid1xtr =  1.00000000000000000E+00_dp
...
sys%fc%kidageu(3) = 17
sys%fc%kidageu(4) = 18
sys%fc%kidcred(1) =  9.69999999999999929E+00_dp
sys%fc%kidcred(2) =  1.61000000000000014E+01_dp
sys%fc%kidcred(3) =  2.00500000000000007E+01_dp
sys%fc%kidcred(4) =  2.79499999999999993E+01_dp
...
sys%incsup%MainCou =  6.22500000000000000E+01_dp
sys%incsup%YngCou =  4.72999999999999972E+01_dp
sys%incsup%MainLP =  3.96499999999999986E+01_dp
sys%incsup%YngLP =  2.36499999999999986E+01_dp
sys%incsup%MainSin =  3.96499999999999986E+01_dp
sys%incsup%YngSin =  3.11499999999999986E+01_dp
...
sys%incsup%PremFam =  7.95000000000000018E+00_dp
sys%incsup%PremLP =  4.45000000000000018E+00_dp
...
sys%incsup%AddKid(1) =  1.35999999999999996E+01_dp
sys%incsup%AddKid(2) =  2.00000000000000000E+01_dp
sys%incsup%AddKid(3) =  2.38999999999999986E+01_dp
sys%incsup%AddKid(4) =  3.13999999999999986E+01_dp
...
sys%rebatesys%MainCou =  6.22500000000000000E+01_dp
sys%rebatesys%YngCou =  4.72999999999999972E+01_dp
sys%rebatesys%MainLP =  3.96499999999999986E+01_dp
sys%rebatesys%YngLP =  3.11499999999999986E+01_dp
sys%rebatesys%MainSin =  3.96499999999999986E+01_dp
sys%rebatesys%YngSin =  3.11499999999999986E+01_dp
...
sys%rebatesys%PremFam =  8.69999999999999929E+00_dp
sys%rebatesys%PremLP =  1.00500000000000007E+01_dp
...
sys%rebatesys%AddKid(1) =  1.35999999999999996E+01_dp
sys%rebatesys%AddKid(2) =  2.00000000000000000E+01_dp
sys%rebatesys%AddKid(3) =  2.38999999999999986E+01_dp
sys%rebatesys%AddKid(4) =  3.13999999999999986E+01_dp
...
sys%ccben%CCrate =  4.69269230769230994E+00_dp
