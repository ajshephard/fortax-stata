...
sys%inctax%pa =  8.72115384615384954E+01_dp
...
sys%inctax%ctc =  1.00000000000000000E+01_dp
...
sys%inctax%bands(1) =  3.61538461538462030E+01_dp
sys%inctax%bands(2) =  5.65384615384615017E+02_dp
...
sys%natins%c2floor =  7.60999999999999943E+01_dp
sys%natins%c2rate =  2.00000000000000000E+00_dp
sys%natins%ceiling =  5.75000000000000000E+02_dp
...
sys%natins%bands(1) =  7.20000000000000000E+01_dp
sys%natins%bands(2) =  8.70000000000000000E+01_dp
sys%natins%bands(3) =  5.75000000000000000E+02_dp
...
sys%natins%c4bands(1) =  8.72099999999999937E+01_dp
sys%natins%c4bands(2) =  5.75000000000000000E+02_dp
sys%natins%c4bands(3) =  1.00000000000000000E+06_dp
 
! chben
sys%chben%doChBen = 1
sys%chben%basic =  1.03499999999999996E+01_dp
sys%chben%kid1xtr =  5.15000000000000036E+00_dp
...
sys%fc%adult =  5.90000000000000000E+01_dp
sys%fc%ftprem =  1.14499999999999993E+01_dp
sys%fc%hours1 =  1.60000000000000000E+01_dp
sys%fc%hours2 =  3.00000000000000000E+01_dp
sys%fc%thres =  9.29000000000000057E+01_dp
...
sys%fc%kidageu(3) = 17
sys%fc%kidageu(4) = 18
sys%fc%kidcred(1) =  2.60000000000000000E+01_dp
sys%fc%kidcred(2) =  2.60000000000000000E+01_dp
sys%fc%kidcred(3) =  2.67500000000000000E+01_dp
sys%fc%kidcred(4) =  2.67500000000000000E+01_dp
...
sys%incsup%MainCou =  8.32500000000000000E+01_dp
sys%incsup%YngCou =  6.33500000000000014E+01_dp
sys%incsup%MainLP =  5.30499999999999972E+01_dp
sys%incsup%YngLP =  3.19499999999999993E+01_dp
sys%incsup%MainSin =  5.30499999999999972E+01_dp
sys%incsup%YngSin =  4.20000000000000000E+01_dp
sys%incsup%ValFSM =  4.19000000000000039E+00_dp
...
sys%incsup%PremFam =  1.45000000000000000E+01_dp
...
sys%incsup%AddKid(1) =  3.29500000000000028E+01_dp
sys%incsup%AddKid(2) =  3.29500000000000028E+01_dp
sys%incsup%AddKid(3) =  3.37500000000000000E+01_dp
sys%incsup%AddKid(4) =  3.37500000000000000E+01_dp
 
! ctax
sys%ctax%docounciltax = 1
sys%ctax%bandD =  1.71255769230768990E+01_dp
...
sys%rebatesys%MainCou =  8.32500000000000000E+01_dp
sys%rebatesys%YngCou =  6.33500000000000014E+01_dp
sys%rebatesys%MainLP =  5.30499999999999972E+01_dp
sys%rebatesys%YngLP =  4.20000000000000000E+01_dp
sys%rebatesys%MainSin =  5.30499999999999972E+01_dp
sys%rebatesys%YngSin =  4.20000000000000000E+01_dp
...
sys%rebatesys%PremFam =  1.45000000000000000E+01_dp
...
sys%rebatesys%AddKid(1) =  3.24500000000000028E+01_dp
sys%rebatesys%AddKid(2) =  3.24500000000000028E+01_dp
sys%rebatesys%AddKid(3) =  3.37500000000000000E+01_dp
sys%rebatesys%AddKid(4) =  3.37500000000000000E+01_dp
