...
sys%inctax%pa =  8.87500000000000000E+01_dp
...
sys%inctax%ctc =  1.01730769230769003E+01_dp
sys%inctax%ctcyng =  1.01730769230769003E+01_dp
sys%inctax%mmarate =  1.00000000000000006E-01_dp
sys%inctax%ctctaper =  6.66666666666666657E-02_dp
sys%inctax%c4rebate =  0.00000000000000000E+00_dp
sys%inctax%bands(1) =  3.69230769230768985E+01_dp
sys%inctax%bands(2) =  5.75000000000000000E+02_dp
...
sys%natins%c2floor =  7.74000000000000057E+01_dp
sys%natins%c2rate =  2.00000000000000000E+00_dp
sys%natins%ceiling =  5.85000000000000000E+02_dp
sys%natins%rates(1) =  0.00000000000000000E+00_dp
sys%natins%rates(2) =  0.00000000000000000E+00_dp
sys%natins%rates(3) =  1.00000000000000006E-01_dp
sys%natins%bands(1) =  7.50000000000000000E+01_dp
sys%natins%bands(2) =  8.90000000000000000E+01_dp
sys%natins%bands(3) =  5.85000000000000000E+02_dp
sys%natins%c4rates(1) =  0.00000000000000000E+00_dp
sys%natins%c4rates(2) =  7.00000000000000067E-02_dp
sys%natins%c4rates(3) =  0.00000000000000000E+00_dp
sys%natins%c4bands(1) =  8.87500000000000000E+01_dp
sys%natins%c4bands(2) =  5.85000000000000000E+02_dp
sys%natins%c4bands(3) =  1.00000000000000000E+06_dp
 
! chben
sys%chben%doChBen = 1
sys%chben%basic =  1.05500000000000007E+01_dp
sys%chben%kid1xtr =  5.20000000000000018E+00_dp
sys%chben%opf =  0.00000000000000000E+00_dp
sys%chben%MatGrantVal =  3.00000000000000000E+02_dp
...
sys%fc%adult =  6.00000000000000000E+01_dp
sys%fc%ftprem =  1.16500000000000004E+01_dp
sys%fc%hours1 =  1.60000000000000000E+01_dp
sys%fc%hours2 =  3.00000000000000000E+01_dp
sys%fc%thres =  9.45000000000000000E+01_dp
...
sys%fc%WFTCMaxCC1 =  1.35000000000000000E+02_dp
sys%fc%WFTCMaxCC2 =  2.00000000000000000E+02_dp
...
sys%fc%kidageu(3) = 17
sys%fc%kidageu(4) = 18
sys%fc%kidcred(1) =  2.64499999999999993E+01_dp
sys%fc%kidcred(2) =  2.64499999999999993E+01_dp
sys%fc%kidcred(3) =  2.71999999999999993E+01_dp
sys%fc%kidcred(4) =  2.71999999999999993E+01_dp
...
sys%incsup%MainCou =  8.46500000000000057E+01_dp
sys%incsup%YngCou =  6.44500000000000028E+01_dp
sys%incsup%MainLP =  5.39500000000000028E+01_dp
sys%incsup%YngLP =  3.25000000000000000E+01_dp
sys%incsup%MainSin =  5.39500000000000028E+01_dp
sys%incsup%YngSin =  4.27000000000000028E+01_dp
sys%incsup%ValFSM =  4.26999999999999957E+00_dp
...
sys%incsup%PremFam =  1.47500000000000000E+01_dp
...
sys%incsup%AddKid(1) =  3.35000000000000000E+01_dp
sys%incsup%AddKid(2) =  3.35000000000000000E+01_dp
sys%incsup%AddKid(3) =  3.42999999999999972E+01_dp
sys%incsup%AddKid(4) =  3.42999999999999972E+01_dp
 
! ctax
sys%ctax%docounciltax = 1
sys%ctax%bandD =  1.85296153846154006E+01_dp
...
sys%rebatesys%MainCou =  8.46500000000000057E+01_dp
sys%rebatesys%YngCou =  6.44500000000000028E+01_dp
sys%rebatesys%MainLP =  5.39500000000000028E+01_dp
sys%rebatesys%YngLP =  4.27000000000000028E+01_dp
sys%rebatesys%MainSin =  5.39500000000000028E+01_dp
sys%rebatesys%YngSin =  4.27000000000000028E+01_dp
...
sys%rebatesys%PremFam =  1.47500000000000000E+01_dp
sys%rebatesys%PremLP =  0.00000000000000000E+00_dp
sys%rebatesys%MaintDisreg =  1.50000000000000000E+01_dp
sys%rebatesys%MaxCC1 =  9.45000000000000000E+01_dp
sys%rebatesys%MaxCC2 =  1.40000000000000000E+02_dp
...
sys%rebatesys%AddKid(1) =  3.35000000000000000E+01_dp
sys%rebatesys%AddKid(2) =  3.35000000000000000E+01_dp
sys%rebatesys%AddKid(3) =  3.42999999999999972E+01_dp
sys%rebatesys%AddKid(4) =  3.42999999999999972E+01_dp
