...
sys%inctax%pa =  9.68269230769230944E+01_dp
...
sys%inctax%bands(1) =  4.13461538461537970E+01_dp
sys%inctax%bands(2) =  6.40384615384615017E+02_dp
...
sys%natins%c2floor =  8.58700000000000045E+01_dp
...
sys%natins%bands(1) =  8.40000000000000000E+01_dp
sys%natins%bands(2) =  9.70000000000000000E+01_dp
sys%natins%bands(3) =  6.45000000000000000E+02_dp
...
sys%natins%c4bands(1) =  9.68299999999999983E+01_dp
sys%natins%c4bands(2) =  6.45000000000000000E+02_dp
sys%natins%c4bands(3) =  1.00000000000000000E+06_dp
 
! chben
sys%chben%doChBen = 1
sys%chben%basic =  1.16999999999999993E+01_dp
sys%chben%kid1xtr =  5.75000000000000000E+00_dp
...
sys%ctc%kid =  3.39423076923077005E+01_dp
 
! wtc
sys%wtc%Basic =  3.20192307692308020E+01_dp
sys%wtc%CouLP =  6.35576923076922995E+01_dp
sys%wtc%FT =  1.30769230769230997E+01_dp
...
sys%wtc%MaxAgeCC = 15
sys%wtc%NewDisreg =  1.49000000000000004E+01_dp
sys%wtc%NewDisregCon = 1
 
! ntc
sys%ntc%donewtaxcred = 1
sys%ntc%thr1lo =  1.00384615384615003E+02_dp
sys%ntc%thr1hi =  2.72211538461537998E+02_dp
...
sys%incsup%MainCou =  9.00999999999999943E+01_dp
sys%incsup%YngCou =  6.86500000000000057E+01_dp
sys%incsup%MainLP =  5.74500000000000028E+01_dp
sys%incsup%YngLP =  3.46000000000000014E+01_dp
sys%incsup%MainSin =  5.74500000000000028E+01_dp
sys%incsup%YngSin =  4.55000000000000000E+01_dp
sys%incsup%ValFSM =  4.37999999999999989E+00_dp
...
sys%ctax%bandD =  2.40348076923077016E+01_dp
...
sys%rebatesys%MainCou =  9.00999999999999943E+01_dp
sys%rebatesys%YngCou =  6.86500000000000057E+01_dp
sys%rebatesys%MainLP =  5.74500000000000028E+01_dp
sys%rebatesys%YngLP =  4.55000000000000000E+01_dp
sys%rebatesys%MainSin =  5.74500000000000028E+01_dp
sys%rebatesys%YngSin =  4.55000000000000000E+01_dp
...
sys%rebatesys%PremFam =  1.62500000000000000E+01_dp
...
sys%rebatesys%AddKid(1) =  5.60799999999999983E+01_dp
sys%rebatesys%AddKid(2) =  4.55799999999999983E+01_dp
