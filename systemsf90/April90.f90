...
sys%inctax%pa=57.7884615384615_dp
...
sys%inctax%bands(1)=398.076923076923_dp
...
sys%natins%c2floor=50.0000000000000_dp
sys%natins%c2rate=4.55000000000000_dp
sys%natins%ceiling=350.000000000000_dp
...
sys%natins%bands(1)=46.0000000000000_dp
sys%natins%bands(2)=350.000000000000_dp
...
sys%natins%c4bands(1)=104.810000000000_dp
sys%natins%c4bands(2)=350.000000000000_dp
sys%natins%c4bands(3)=1000000.00000000_dp
 
!chben
sys%chben%doChBen=.true. 
sys%chben%basic=7.25000000000000_dp
sys%chben%kid1xtr=0.000000000000000E+000_dp
...
sys%fc%kidcred(1)=8.25000000000000_dp
sys%fc%kidcred(2)=14.1500000000000_dp
sys%fc%kidcred(3)=17.8000000000000_dp
sys%fc%kidcred(4)=25.1000000000000_dp
...
sys%incsup%MainCou=57.6000000000000_dp
sys%incsup%YngCou=43.8000000000000_dp
sys%incsup%MainLP=36.7000000000000_dp
sys%incsup%YngLP=21.9000000000000_dp
sys%incsup%MainSin=36.7000000000000_dp
sys%incsup%YngSin=28.8000000000000_dp
sys%incsup%ValFSM=3.30000000000000_dp
...
sys%incsup%PremFam=7.35000000000000_dp
sys%incsup%PremLP=4.10000000000000_dp
...
sys%incsup%AddKid(1)=12.3500000000000_dp
sys%incsup%AddKid(2)=18.2500000000000_dp
sys%incsup%AddKid(3)=21.9000000000000_dp
sys%incsup%AddKid(4)=28.8000000000000_dp
...
sys%rebatesys%MainCou=57.6000000000000_dp
sys%rebatesys%YngCou=43.8000000000000_dp
sys%rebatesys%MainLP=36.7000000000000_dp
sys%rebatesys%YngLP=21.9000000000000_dp
sys%rebatesys%MainSin=36.7000000000000_dp
sys%rebatesys%YngSin=28.8000000000000_dp
...
sys%rebatesys%PremFam=7.35000000000000_dp
sys%rebatesys%PremLP=9.70000000000000_dp
...
sys%rebatesys%AddKid(1)=12.3500000000000_dp
sys%rebatesys%AddKid(2)=18.2500000000000_dp
sys%rebatesys%AddKid(3)=21.9000000000000_dp
sys%rebatesys%AddKid(4)=28.8000000000000_dp
...
sys%ccben%CCrate=6.63269230769231_dp
