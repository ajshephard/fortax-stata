...
sys%inctax%pa =  9.41346153846154010E+01_dp
...
sys%inctax%bands(1) =  4.01923076923077005E+01_dp
sys%inctax%bands(2) =  6.23076923076922981E+02_dp
...
sys%natins%c2floor =  8.38599999999999994E+01_dp
sys%natins%c2rate =  2.10000000000000009E+00_dp
...
sys%natins%bands(1) =  8.20000000000000000E+01_dp
sys%natins%bands(2) =  9.40000000000000000E+01_dp
sys%natins%bands(3) =  6.30000000000000000E+02_dp
...
sys%natins%c4bands(1) =  9.41299999999999955E+01_dp
sys%natins%c4bands(2) =  6.30000000000000000E+02_dp
sys%natins%c4bands(3) =  1.00000000000000000E+06_dp
 
! chben
sys%chben%doChBen = 1
sys%chben%basic =  1.14000000000000004E+01_dp
sys%chben%kid1xtr =  5.59999999999999964E+00_dp
...
sys%ctc%kid =  3.25000000000000000E+01_dp
 
! wtc
sys%wtc%Basic =  3.11538461538461995E+01_dp
sys%wtc%CouLP =  6.18269230769231015E+01_dp
sys%wtc%FT =  1.26923076923077005E+01_dp
...
sys%wtc%MaxAgeCC = 15
sys%wtc%NewDisreg =  1.45000000000000000E+01_dp
sys%wtc%NewDisregCon = 1
 
! ntc
sys%ntc%donewtaxcred = 1
sys%ntc%thr1lo =  1.00384615384615003E+02_dp
sys%ntc%thr1hi =  2.67500000000000000E+02_dp
...
sys%incsup%MainCou =  8.81500000000000057E+01_dp
sys%incsup%YngCou =  6.71500000000000057E+01_dp
sys%incsup%MainLP =  5.62000000000000028E+01_dp
sys%incsup%YngLP =  3.38500000000000014E+01_dp
sys%incsup%MainSin =  5.62000000000000028E+01_dp
sys%incsup%YngSin =  4.45000000000000000E+01_dp
sys%incsup%ValFSM =  4.37000000000000011E+00_dp
...
sys%ctax%bandD =  2.30142307692307995E+01_dp
...
sys%rebatesys%MainCou =  8.81500000000000057E+01_dp
sys%rebatesys%YngCou =  6.71500000000000057E+01_dp
sys%rebatesys%MainLP =  5.62000000000000028E+01_dp
sys%rebatesys%YngLP =  4.45000000000000000E+01_dp
sys%rebatesys%MainSin =  5.62000000000000028E+01_dp
sys%rebatesys%YngSin =  4.45000000000000000E+01_dp
...
sys%rebatesys%PremFam =  1.61000000000000014E+01_dp
...
sys%rebatesys%AddKid(1) =  5.43599999999999994E+01_dp
sys%rebatesys%AddKid(2) =  4.38800000000000026E+01_dp
