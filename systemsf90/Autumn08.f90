...
sys%inctax%pa =  1.16057692307691994E+02_dp
...
sys%inctax%bands(1) =  4.46153846153845990E+01_dp
sys%inctax%bands(2) =  6.69230769230769056E+02_dp
...
sys%natins%c2floor =  9.27900000000000063E+01_dp
sys%natins%c2rate =  2.29999999999999982E+00_dp
...
sys%natins%bands(1) =  9.00000000000000000E+01_dp
sys%natins%bands(2) =  1.05000000000000000E+02_dp
...
sys%natins%c4bands(1) =  1.04519999999999996E+02_dp
sys%natins%c4bands(2) =  7.70000000000000000E+02_dp
sys%natins%c4bands(3) =  1.00000000000000000E+06_dp
 
! chben
sys%chben%doChBen = 1
sys%chben%basic =  1.25500000000000007E+01_dp
sys%chben%kid1xtr =  6.25000000000000000E+00_dp
...
sys%ctc%kid =  4.00961538461537970E+01_dp
 
! wtc
sys%wtc%Basic =  3.46153846153845990E+01_dp
sys%wtc%CouLP =  6.86538461538462030E+01_dp
sys%wtc%FT =  1.41346153846153992E+01_dp
...
sys%wtc%MaxAgeCC = 15
sys%wtc%NewDisreg =  1.60500000000000007E+01_dp
sys%wtc%NewDisregCon = 1
 
! ntc
sys%ntc%donewtaxcred = 1
sys%ntc%thr1lo =  1.23461538461537998E+02_dp
sys%ntc%thr1hi =  2.99519230769231001E+02_dp
...
sys%incsup%MainCou =  9.49500000000000028E+01_dp
sys%incsup%YngCou =  7.23499999999999943E+01_dp
sys%incsup%MainLP =  6.05000000000000000E+01_dp
sys%incsup%YngLP =  4.79500000000000028E+01_dp
sys%incsup%MainSin =  6.05000000000000000E+01_dp
sys%incsup%YngSin =  4.79500000000000028E+01_dp
sys%incsup%ValFSM =  4.95999999999999996E+00_dp
...
sys%ctax%bandD =  2.60296153846154006E+01_dp
...
sys%rebatesys%MainCou =  9.49500000000000028E+01_dp
sys%rebatesys%YngCou =  7.23499999999999943E+01_dp
sys%rebatesys%MainLP =  6.05000000000000000E+01_dp
sys%rebatesys%YngLP =  4.79500000000000028E+01_dp
sys%rebatesys%MainSin =  6.05000000000000000E+01_dp
sys%rebatesys%YngSin =  4.79500000000000028E+01_dp
...
sys%rebatesys%PremFam =  1.67500000000000000E+01_dp
...
sys%rebatesys%AddKid(1) =  6.30900000000000034E+01_dp
sys%rebatesys%AddKid(2) =  5.25900000000000034E+01_dp
