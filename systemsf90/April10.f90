...
sys%ctc%kid=44.2307692307692_dp
 
!wtc
sys%wtc%Basic=36.9230769230769_dp
sys%wtc%CouLP=73.2692307692308_dp
...
sys%ntc%thr1hi=311.346153846154_dp
...
sys%incsup%MainCou=102.750000000000_dp
sys%incsup%YngCou=78.3000000000000_dp
sys%incsup%MainLP=65.4500000000000_dp
sys%incsup%YngLP=51.8500000000000_dp
sys%incsup%MainSin=65.4500000000000_dp
sys%incsup%YngSin=51.8500000000000_dp
sys%incsup%ValFSM=5.52000000000000_dp
...
sys%ctax%bandD=27.3205769230769_dp
...
sys%rebatesys%MainCou=102.750000000000_dp
sys%rebatesys%YngCou=78.3000000000000_dp
sys%rebatesys%MainLP=65.4500000000000_dp
sys%rebatesys%YngLP=51.8500000000000_dp
sys%rebatesys%MainSin=65.4500000000000_dp
sys%rebatesys%YngSin=51.8500000000000_dp
...
sys%rebatesys%AddKid(1)=68.0700000000000_dp
sys%rebatesys%AddKid(2)=57.5700000000000_dp
