...
sys%inctax%pa =  8.43269230769230944E+01_dp
...
sys%inctax%bands(1) =  2.92307692307692015E+01_dp
sys%inctax%bands(2) =  5.46153846153845961E+02_dp
...
sys%natins%c2floor =  7.35000000000000000E+01_dp
sys%natins%c2rate =  2.00000000000000000E+00_dp
sys%natins%ceiling =  5.35000000000000000E+02_dp
...
sys%natins%bands(1) =  6.70000000000000000E+01_dp
sys%natins%bands(2) =  7.60000000000000000E+01_dp
sys%natins%bands(3) =  5.35000000000000000E+02_dp
...
sys%natins%c4bands(1) =  8.40000000000000000E+01_dp
sys%natins%c4bands(2) =  5.35000000000000000E+02_dp
sys%natins%c4bands(3) =  1.00000000000000000E+06_dp
 
! chben
sys%chben%doChBen = 1
sys%chben%basic =  1.00000000000000000E+01_dp
sys%chben%kid1xtr =  5.00000000000000000E+00_dp
...
sys%fc%adult =  5.31499999999999986E+01_dp
sys%fc%ftprem =  1.12500000000000000E+01_dp
sys%fc%hours1 =  1.60000000000000000E+01_dp
sys%fc%hours2 =  3.00000000000000000E+01_dp
sys%fc%thres =  9.14500000000000028E+01_dp
...
sys%fc%kidageu(3) = 17
sys%fc%kidageu(4) = 18
sys%fc%kidcred(1) =  2.56000000000000014E+01_dp
sys%fc%kidcred(2) =  2.56000000000000014E+01_dp
sys%fc%kidcred(3) =  2.63500000000000014E+01_dp
sys%fc%kidcred(4) =  2.63500000000000014E+01_dp
...
sys%incsup%MainCou =  8.19500000000000028E+01_dp
sys%incsup%YngCou =  6.23500000000000014E+01_dp
sys%incsup%MainLP =  5.22000000000000028E+01_dp
sys%incsup%YngLP =  3.14499999999999993E+01_dp
sys%incsup%MainSin =  5.22000000000000028E+01_dp
sys%incsup%YngSin =  4.13500000000000014E+01_dp
sys%incsup%ValFSM =  4.04000000000000004E+00_dp
...
sys%incsup%PremFam =  1.42500000000000000E+01_dp
...
sys%incsup%AddKid(1) =  3.09499999999999993E+01_dp
sys%incsup%AddKid(2) =  3.09499999999999993E+01_dp
sys%incsup%AddKid(3) =  3.17500000000000000E+01_dp
sys%incsup%AddKid(4) =  3.17500000000000000E+01_dp
 
! ctax
sys%ctax%docounciltax = 1
sys%ctax%bandD =  1.60913461538461995E+01_dp
...
sys%rebatesys%MainCou =  8.19500000000000028E+01_dp
sys%rebatesys%YngCou =  6.23500000000000014E+01_dp
sys%rebatesys%MainLP =  5.22000000000000028E+01_dp
sys%rebatesys%YngLP =  4.13500000000000014E+01_dp
sys%rebatesys%MainSin =  5.22000000000000028E+01_dp
sys%rebatesys%YngSin =  4.13500000000000014E+01_dp
...
sys%rebatesys%PremFam =  1.42500000000000000E+01_dp
...
sys%rebatesys%AddKid(1) =  3.09499999999999993E+01_dp
sys%rebatesys%AddKid(2) =  3.09499999999999993E+01_dp
sys%rebatesys%AddKid(3) =  3.17500000000000000E+01_dp
sys%rebatesys%AddKid(4) =  3.17500000000000000E+01_dp
