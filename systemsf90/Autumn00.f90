...
sys%natins%rates(3)=0.100000000000000_dp
allocate(sys%natins%bands(3))
sys%natins%bands(1)=67.0000000000000_dp
sys%natins%bands(2)=76.0000000000000_dp
sys%natins%bands(3)=535.000000000000_dp
