...
sys%inctax%bands(1) =  4.80769230769231015E+01_dp
...
sys%natins%c2floor =  6.03800000000000026E+01_dp
sys%natins%c2rate =  5.54999999999999982E+00_dp
sys%natins%ceiling =  4.20000000000000000E+02_dp
sys%natins%rates(1) =  2.00000000000000004E-02_dp
sys%natins%rates(2) =  8.99999999999999967E-02_dp
sys%natins%bands(1) =  5.60000000000000000E+01_dp
sys%natins%bands(2) =  4.20000000000000000E+02_dp
...
sys%natins%c4bands(1) =  1.21930000000000007E+02_dp
sys%natins%c4bands(2) =  4.20000000000000000E+02_dp
sys%natins%c4bands(3) =  1.00000000000000000E+06_dp
 
! chben
sys%chben%doChBen = 1
sys%chben%basic =  8.09999999999999964E+00_dp
sys%chben%kid1xtr =  1.89999999999999991E+00_dp
...
sys%fc%kidageu(3) = 17
sys%fc%kidageu(4) = 18
sys%fc%kidcred(1) =  1.07500000000000000E+01_dp
sys%fc%kidcred(2) =  1.78500000000000014E+01_dp
sys%fc%kidcred(3) =  2.21999999999999993E+01_dp
sys%fc%kidcred(4) =  3.10000000000000000E+01_dp
...
sys%incsup%MainCou =  6.90000000000000000E+01_dp
sys%incsup%YngCou =  5.23999999999999986E+01_dp
sys%incsup%MainLP =  4.40000000000000000E+01_dp
sys%incsup%YngLP =  2.64499999999999993E+01_dp
sys%incsup%MainSin =  4.40000000000000000E+01_dp
sys%incsup%YngSin =  3.47999999999999972E+01_dp
...
sys%incsup%PremFam =  9.65000000000000036E+00_dp
sys%incsup%PremLP =  4.90000000000000036E+00_dp
...
sys%incsup%AddKid(1) =  1.50500000000000007E+01_dp
sys%incsup%AddKid(2) =  2.21499999999999986E+01_dp
sys%incsup%AddKid(3) =  2.64499999999999993E+01_dp
sys%incsup%AddKid(4) =  3.47999999999999972E+01_dp
 
! ctax
sys%ctax%docounciltax = 1
sys%ctax%bandD =  1.08048076923076994E+01_dp
...
sys%rebatesys%MainCou =  6.90000000000000000E+01_dp
sys%rebatesys%YngCou =  5.23999999999999986E+01_dp
sys%rebatesys%MainLP =  4.40000000000000000E+01_dp
sys%rebatesys%YngLP =  3.47999999999999972E+01_dp
sys%rebatesys%MainSin =  4.40000000000000000E+01_dp
sys%rebatesys%YngSin =  3.47999999999999972E+01_dp
...
sys%rebatesys%PremFam =  9.65000000000000036E+00_dp
sys%rebatesys%PremLP =  1.09499999999999993E+01_dp
...
sys%rebatesys%AddKid(1) =  1.50500000000000007E+01_dp
sys%rebatesys%AddKid(2) =  2.21499999999999986E+01_dp
sys%rebatesys%AddKid(3) =  2.64499999999999993E+01_dp
sys%rebatesys%AddKid(4) =  3.47999999999999972E+01_dp
