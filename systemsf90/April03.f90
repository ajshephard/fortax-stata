...
sys%inctax%bands(1) =  3.76923076923077005E+01_dp
sys%inctax%bands(2) =  5.86538461538462002E+02_dp
...
sys%natins%c2floor =  7.87500000000000000E+01_dp
...
sys%natins%bands(1) =  7.70000000000000000E+01_dp
sys%natins%bands(2) =  8.90000000000000000E+01_dp
sys%natins%bands(3) =  5.95000000000000000E+02_dp
...
sys%natins%c4bands(2) =  5.95000000000000000E+02_dp
sys%natins%c4bands(3) =  1.00000000000000000E+06_dp
 
! chben
sys%chben%doChBen = 1
sys%chben%basic =  1.07500000000000000E+01_dp
sys%chben%kid1xtr =  5.29999999999999982E+00_dp
...
sys%ctc%kid =  2.77884615384615010E+01_dp
 
! wtc
sys%wtc%Basic =  2.93269230769231015E+01_dp
sys%wtc%CouLP =  5.81730769230768985E+01_dp
sys%wtc%FT =  1.19230769230769003E+01_dp
...
sys%ntc%thr1hi =  2.54423076923076991E+02_dp
...
sys%incsup%MainCou =  8.57500000000000000E+01_dp
sys%incsup%YngCou =  6.52999999999999972E+01_dp
sys%incsup%MainLP =  5.46499999999999986E+01_dp
sys%incsup%YngLP =  3.28999999999999986E+01_dp
sys%incsup%MainSin =  5.46499999999999986E+01_dp
sys%incsup%YngSin =  4.32500000000000000E+01_dp
sys%incsup%ValFSM =  4.28000000000000025E+00_dp
...
sys%ctax%bandD =  2.09001923076923006E+01_dp
...
sys%rebatesys%MainCou =  8.57500000000000000E+01_dp
sys%rebatesys%YngCou =  6.52999999999999972E+01_dp
sys%rebatesys%MainLP =  5.46499999999999986E+01_dp
sys%rebatesys%YngLP =  4.32500000000000000E+01_dp
sys%rebatesys%MainSin =  5.46499999999999986E+01_dp
sys%rebatesys%YngSin =  4.32500000000000000E+01_dp
...
sys%rebatesys%PremFam =  1.57500000000000000E+01_dp
...
sys%rebatesys%AddKid(1) =  4.89500000000000028E+01_dp
sys%rebatesys%AddKid(2) =  3.85000000000000000E+01_dp
