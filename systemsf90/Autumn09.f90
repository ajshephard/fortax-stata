...
sys%natins%bands(1) =  9.50000000000000000E+01_dp
...
! chben
sys%chben%doChBen = 1
sys%chben%basic =  1.31999999999999993E+01_dp
sys%chben%kid1xtr =  6.79999999999999982E+00_dp
...
sys%ctc%kid =  4.29807692307691980E+01_dp
 
! wtc
sys%wtc%Basic =  3.63461538461537970E+01_dp
sys%wtc%CouLP =  7.21153846153845990E+01_dp
sys%wtc%FT =  1.49038461538461995E+01_dp
...
sys%wtc%MaxAgeCC = 15
sys%wtc%NewDisreg =  1.68500000000000014E+01_dp
sys%wtc%NewDisregCon = 1
 
! ntc
sys%ntc%donewtaxcred = 1
sys%ntc%thr1lo =  1.23461538461537998E+02_dp
sys%ntc%thr1hi =  3.08461538461537998E+02_dp
...
sys%incsup%MainCou =  1.00950000000000003E+02_dp
sys%incsup%YngCou =  7.69000000000000057E+01_dp
sys%incsup%MainLP =  6.42999999999999972E+01_dp
sys%incsup%YngLP =  5.09500000000000028E+01_dp
sys%incsup%MainSin =  6.42999999999999972E+01_dp
sys%incsup%YngSin =  5.09500000000000028E+01_dp
sys%incsup%ValFSM =  5.37999999999999989E+00_dp
...
sys%ctax%bandD =  2.68167307692308015E+01_dp
...
sys%rebatesys%MainCou =  1.00950000000000003E+02_dp
sys%rebatesys%YngCou =  7.69000000000000057E+01_dp
sys%rebatesys%MainLP =  6.42999999999999972E+01_dp
sys%rebatesys%YngLP =  5.09500000000000028E+01_dp
sys%rebatesys%MainSin =  6.42999999999999972E+01_dp
sys%rebatesys%YngSin =  5.09500000000000028E+01_dp
...
sys%rebatesys%PremFam =  1.73000000000000007E+01_dp
sys%rebatesys%PremLP =  0.00000000000000000E+00_dp
sys%rebatesys%MaintDisreg =  2.50000000000000000E+01_dp
...
sys%rebatesys%AddKid(1) =  6.66599999999999966E+01_dp
sys%rebatesys%AddKid(2) =  5.61099999999999994E+01_dp
