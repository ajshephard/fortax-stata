...
sys%inctax%pa =  7.24038461538461036E+01_dp
...
sys%inctax%mma =  3.44230769230768985E+01_dp
sys%inctax%ctc =  0.00000000000000000E+00_dp
sys%inctax%ctcyng =  0.00000000000000000E+00_dp
sys%inctax%mmarate =  1.49999999999999994E-01_dp
sys%inctax%ctctaper =  0.00000000000000000E+00_dp
sys%inctax%c4rebate =  0.00000000000000000E+00_dp
sys%inctax%bands(1) =  7.50000000000000000E+01_dp
sys%inctax%bands(2) =  4.90384615384615017E+02_dp
sys%inctax%bands(3) =  1.92307500000000000E+04_dp
sys%inctax%rates(1) =  2.00000000000000011E-01_dp
sys%inctax%rates(2) =  2.39999999999999991E-01_dp
sys%inctax%rates(3) =  4.00000000000000022E-01_dp
 
! natins
sys%natins%numrates = 2
sys%natins%c4nrates = 3
sys%natins%c2floor =  6.59599999999999937E+01_dp
sys%natins%c2rate =  6.04999999999999982E+00_dp
sys%natins%ceiling =  4.55000000000000000E+02_dp
sys%natins%rates(1) =  2.00000000000000004E-02_dp
sys%natins%rates(2) =  1.00000000000000006E-01_dp
sys%natins%bands(1) =  6.10000000000000000E+01_dp
sys%natins%bands(2) =  4.55000000000000000E+02_dp
...
sys%natins%c4bands(1) =  1.31919999999999987E+02_dp
sys%natins%c4bands(2) =  4.55000000000000000E+02_dp
sys%natins%c4bands(3) =  1.00000000000000000E+06_dp
 
! chben
sys%chben%doChBen = 1
sys%chben%basic =  8.80000000000000071E+00_dp
sys%chben%kid1xtr =  2.00000000000000000E+00_dp
sys%chben%opf =  6.29999999999999982E+00_dp
...
sys%fc%kidageu(3) = 17
sys%fc%kidageu(4) = 18
sys%fc%kidcred(1) =  1.17500000000000000E+01_dp
sys%fc%kidcred(2) =  1.94499999999999993E+01_dp
sys%fc%kidcred(3) =  2.41499999999999986E+01_dp
sys%fc%kidcred(4) =  3.37999999999999972E+01_dp
...
sys%incsup%MainCou =  7.52000000000000028E+01_dp
sys%incsup%YngCou =  5.72000000000000028E+01_dp
sys%incsup%MainLP =  4.78999999999999986E+01_dp
sys%incsup%YngLP =  2.88500000000000014E+01_dp
sys%incsup%MainSin =  4.78999999999999986E+01_dp
sys%incsup%YngSin =  3.78999999999999986E+01_dp
sys%incsup%ValFSM =  4.00000000000000000E+00_dp
...
sys%incsup%PremFam =  1.05500000000000007E+01_dp
sys%incsup%PremLP =  5.20000000000000018E+00_dp
...
sys%incsup%AddKid(1) =  1.64499999999999993E+01_dp
sys%incsup%AddKid(2) =  2.41000000000000014E+01_dp
sys%incsup%AddKid(3) =  2.88500000000000014E+01_dp
sys%incsup%AddKid(4) =  3.78999999999999986E+01_dp
 
! ctax
sys%ctax%docounciltax = 1
sys%ctax%bandD =  1.22423076923076994E+01_dp
...
sys%rebatesys%MainCou =  7.52000000000000028E+01_dp
sys%rebatesys%YngCou =  5.72000000000000028E+01_dp
sys%rebatesys%MainLP =  4.78999999999999986E+01_dp
sys%rebatesys%YngLP =  3.78999999999999986E+01_dp
sys%rebatesys%MainSin =  4.78999999999999986E+01_dp
sys%rebatesys%YngSin =  3.78999999999999986E+01_dp
...
sys%rebatesys%PremFam =  1.05500000000000007E+01_dp
sys%rebatesys%PremLP =  1.15000000000000000E+01_dp
sys%rebatesys%MaintDisreg =  1.50000000000000000E+01_dp
sys%rebatesys%MaxCC1 =  6.00000000000000000E+01_dp
...
sys%rebatesys%AddKid(1) =  1.64499999999999993E+01_dp
sys%rebatesys%AddKid(2) =  2.41000000000000014E+01_dp
sys%rebatesys%AddKid(3) =  2.88500000000000014E+01_dp
sys%rebatesys%AddKid(4) =  3.78999999999999986E+01_dp
