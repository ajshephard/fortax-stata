...
sys%inctax%pa =  1.81538461538462002E+02_dp
...
sys%inctax%bands(1) =  5.36538461538462030E+01_dp
sys%inctax%bands(2) =  6.15576923076922981E+02_dp
...
sys%inctax%rates(4) =  4.50000000000000011E-01_dp
 
! natins
sys%natins%numrates = 5
sys%natins%c4nrates = 3
sys%natins%c2floor =  1.10099999999999994E+02_dp
sys%natins%c2rate =  2.70000000000000018E+00_dp
...
sys%natins%rates(3) =  1.19999999999999996E-01_dp
sys%natins%rates(4) =  1.19999999999999996E-01_dp
sys%natins%rates(5) =  2.00000000000000004E-02_dp
sys%natins%bands(1) =  1.09000000000000000E+02_dp
sys%natins%bands(2) =  1.49000000000000000E+02_dp
sys%natins%bands(3) =  7.70000000000000000E+02_dp
sys%natins%bands(4) =  7.97000000000000000E+02_dp
sys%natins%bands(5) =  1.00000000000000002+100_dp
sys%natins%c4rates(1) =  0.00000000000000000E+00_dp
sys%natins%c4rates(2) =  8.99999999999999967E-02_dp
sys%natins%c4rates(3) =  2.00000000000000004E-02_dp
sys%natins%c4bands(1) =  1.49129999999999995E+02_dp
sys%natins%c4bands(2) =  7.97110000000000014E+02_dp
...
sys%chben%MatGrantOnlyFirstKid = 1
sys%chben%doTaper = 1
sys%chben%disableTaperRounding = 0
sys%chben%taperStart =  9.61538461538462002E+02_dp
sys%chben%taperRate =  1.00000000000002275E-02_dp
...
sys%ctc%kid =  5.23076923076922995E+01_dp
 
! wtc
sys%wtc%Basic =  3.69230769230768985E+01_dp
sys%wtc%CouLP =  7.48076923076923066E+01_dp
sys%wtc%FT =  1.51923076923077005E+01_dp
sys%wtc%MinHrsKids =  1.60000000000000000E+01_dp
sys%wtc%MinHrsCouKids =  2.40000000000000000E+01_dp
...
sys%wtc%PropCC =  6.99999999999999956E-01_dp
sys%wtc%MaxAgeCC = 15
...
sys%ntc%thr1hi =  3.05961538461537998E+02_dp
sys%ntc%thr2 =  0.00000000000000000E+00_dp
sys%ntc%taper1 =  4.09999999999999976E-01_dp
sys%ntc%taper2 =  0.00000000000000000E+00_dp
sys%ntc%taperCTCInOneGo = 1
...
sys%incsup%MainCou =  1.12549999999999997E+02_dp
sys%incsup%YngCou =  8.57999999999999972E+01_dp
sys%incsup%MainLP =  7.17000000000000028E+01_dp
sys%incsup%YngLP =  5.67999999999999972E+01_dp
sys%incsup%MainSin =  7.17000000000000028E+01_dp
sys%incsup%YngSin =  5.67999999999999972E+01_dp
sys%incsup%ValFSM =  6.13999999999999968E+00_dp
...
sys%ctax%bandD =  2.77325000000000017E+01_dp
...
sys%rebatesys%MainCou =  1.12549999999999997E+02_dp
sys%rebatesys%YngCou =  8.57999999999999972E+01_dp
sys%rebatesys%MainLP =  7.17000000000000028E+01_dp
sys%rebatesys%YngLP =  5.67999999999999972E+01_dp
sys%rebatesys%MainSin =  7.17000000000000028E+01_dp
sys%rebatesys%YngSin =  5.67999999999999972E+01_dp
...
sys%rebatesys%AddKid(1) =  6.56200000000000045E+01_dp
...
sys%ctaxben%doEntitlementCut = 1
sys%ctaxben%entitlementShare =  8.96000000000000019E-01_dp
...
sys%bencap%sinNoKids =  3.50000000000000000E+02_dp
sys%bencap%sinKids =  5.00000000000000000E+02_dp
sys%bencap%couNoKids =  5.00000000000000000E+02_dp
sys%bencap%couKids =  5.00000000000000000E+02_dp
