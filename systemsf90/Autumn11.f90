...
sys%inctax%pa =  1.43750000000000000E+02_dp
...
sys%inctax%bands(1) =  4.92307692307691980E+01_dp
sys%inctax%bands(2) =  6.73076923076922981E+02_dp
...
sys%natins%c2floor =  1.02209999999999994E+02_dp
sys%natins%c2rate =  2.50000000000000000E+00_dp
...
sys%natins%rates(4) =  2.00000000000000004E-02_dp
sys%natins%bands(1) =  1.02000000000000000E+02_dp
sys%natins%bands(2) =  1.39000000000000000E+02_dp
sys%natins%bands(3) =  8.17000000000000000E+02_dp
...
sys%natins%c4bands(1) =  1.38939999999999998E+02_dp
sys%natins%c4bands(2) =  8.16830000000000041E+02_dp
...
sys%ctc%kid =  4.91346153846154010E+01_dp
 
! wtc
sys%wtc%Basic =  3.69230769230768985E+01_dp
sys%wtc%CouLP =  7.44230769230769056E+01_dp
...
sys%ntc%thr1hi =  3.05000000000000000E+02_dp
sys%ntc%thr2 =  7.69230769230769056E+02_dp
sys%ntc%taper1 =  4.09999999999999976E-01_dp
sys%ntc%taper2 =  4.09999999999999976E-01_dp
...
sys%incsup%MainCou =  1.05950000000000003E+02_dp
sys%incsup%YngCou =  8.07500000000000000E+01_dp
sys%incsup%MainLP =  6.75000000000000000E+01_dp
sys%incsup%YngLP =  5.34500000000000028E+01_dp
sys%incsup%MainSin =  6.75000000000000000E+01_dp
sys%incsup%YngSin =  5.34500000000000028E+01_dp
sys%incsup%ValFSM =  5.79000000000000004E+00_dp
...
sys%ctax%bandD =  2.73638461538462003E+01_dp
...
sys%rebatesys%MainCou =  1.05950000000000003E+02_dp
sys%rebatesys%YngCou =  8.07500000000000000E+01_dp
sys%rebatesys%MainLP =  6.75000000000000000E+01_dp
sys%rebatesys%YngLP =  5.34500000000000028E+01_dp
sys%rebatesys%MainSin =  6.75000000000000000E+01_dp
sys%rebatesys%YngSin =  5.34500000000000028E+01_dp
...
sys%rebatesys%AddKid(1) =  6.23299999999999983E+01_dp
...
sys%bencap%sinNoKids =  0.00000000000000000E+00_dp
sys%bencap%sinKids =  0.00000000000000000E+00_dp
sys%bencap%couNoKids =  0.00000000000000000E+00_dp
sys%bencap%couKids =  0.00000000000000000E+00_dp
sys%bencap%UCEarnThr =  0.00000000000000000E+00_dp
 
! extra
sys%extra%fsminappamt = 0
sys%extra%matgrant = 0
sys%extra%prices = 20111201
