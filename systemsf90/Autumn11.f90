...
sys%inctax%pa=143.750000000000_dp
...
sys%inctax%bands(1)=49.2307692307692_dp
sys%inctax%bands(2)=673.076923076923_dp
...
sys%natins%c2floor=102.210000000000_dp
sys%natins%c2rate=2.50000000000000_dp
...
sys%natins%rates(4)=2.000000000000000E-002_dp
allocate(sys%natins%bands(4))
sys%natins%bands(1)=102.000000000000_dp
sys%natins%bands(2)=139.000000000000_dp
sys%natins%bands(3)=817.000000000000_dp
...
sys%natins%c4bands(1)=138.940000000000_dp
...
sys%ctc%kid=49.1346153846154_dp
...
sys%ntc%thr2=769.230769230769_dp
sys%ntc%taper1=0.410000000000000_dp
sys%ntc%taper2=0.410000000000000_dp
...
sys%incsup%MainCou=105.950000000000_dp
sys%incsup%YngCou=80.7500000000000_dp
sys%incsup%MainLP=67.5000000000000_dp
sys%incsup%YngLP=53.4500000000000_dp
sys%incsup%MainSin=67.5000000000000_dp
sys%incsup%YngSin=53.4500000000000_dp
sys%incsup%ValFSM=5.79000000000000_dp
...
sys%ctax%bandD=27.3638461538462_dp
...
sys%rebatesys%MainCou=105.950000000000_dp
sys%rebatesys%YngCou=80.7500000000000_dp
sys%rebatesys%MainLP=67.5000000000000_dp
sys%rebatesys%YngLP=53.4500000000000_dp
sys%rebatesys%MainSin=67.5000000000000_dp
sys%rebatesys%YngSin=53.4500000000000_dp
...
sys%rebatesys%AddKid(1)=62.3300000000000_dp
...
sys%bencap%sinNoKids=0.000000000000000E+000_dp
sys%bencap%sinKids=0.000000000000000E+000_dp
sys%bencap%couNoKids=0.000000000000000E+000_dp
sys%bencap%couKids=0.000000000000000E+000_dp
