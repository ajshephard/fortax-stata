...
sys%inctax%pa =  9.12500000000000000E+01_dp
...
sys%inctax%bands(1) =  3.88461538461537970E+01_dp
sys%inctax%bands(2) =  6.03846153846154039E+02_dp
...
sys%natins%c2floor =  8.10499999999999972E+01_dp
sys%natins%c2rate =  2.04999999999999982E+00_dp
...
sys%natins%bands(1) =  7.90000000000000000E+01_dp
sys%natins%bands(2) =  9.10000000000000000E+01_dp
sys%natins%bands(3) =  6.10000000000000000E+02_dp
...
sys%natins%c4bands(1) =  9.12500000000000000E+01_dp
sys%natins%c4bands(2) =  6.10000000000000000E+02_dp
sys%natins%c4bands(3) =  1.00000000000000000E+06_dp
 
! chben
sys%chben%doChBen = 1
sys%chben%basic =  1.10500000000000007E+01_dp
sys%chben%kid1xtr =  5.45000000000000018E+00_dp
...
sys%ctc%kid =  3.12500000000000000E+01_dp
 
! wtc
sys%wtc%Basic =  3.01923076923077005E+01_dp
sys%wtc%CouLP =  5.99038461538462030E+01_dp
sys%wtc%FT =  1.23076923076922995E+01_dp
...
sys%wtc%MaxCC1 =  1.35000000000000000E+02_dp
sys%wtc%MaxCC2 =  2.00000000000000000E+02_dp
sys%wtc%PropCC =  6.99999999999999956E-01_dp
sys%wtc%MaxAgeCC = 15
sys%wtc%NewDisreg =  1.23200000000000003E+01_dp
sys%wtc%NewDisregCon = 1
 
! ntc
sys%ntc%donewtaxcred = 1
sys%ntc%thr1lo =  9.73076923076923066E+01_dp
sys%ntc%thr1hi =  2.59230769230768999E+02_dp
...
sys%incsup%MainCou =  8.72999999999999972E+01_dp
sys%incsup%YngCou =  6.65000000000000000E+01_dp
sys%incsup%MainLP =  5.56499999999999986E+01_dp
sys%incsup%YngLP =  3.35000000000000000E+01_dp
sys%incsup%MainSin =  5.56499999999999986E+01_dp
sys%incsup%YngSin =  4.40499999999999972E+01_dp
sys%incsup%ValFSM =  4.33999999999999986E+00_dp
...
sys%ctax%bandD =  2.21301923076923011E+01_dp
...
sys%rebatesys%MainCou =  8.72999999999999972E+01_dp
sys%rebatesys%YngCou =  6.65000000000000000E+01_dp
sys%rebatesys%MainLP =  5.56499999999999986E+01_dp
sys%rebatesys%YngLP =  4.40499999999999972E+01_dp
sys%rebatesys%MainSin =  5.56499999999999986E+01_dp
sys%rebatesys%YngSin =  4.40499999999999972E+01_dp
...
sys%rebatesys%PremFam =  1.59499999999999993E+01_dp
sys%rebatesys%PremLP =  0.00000000000000000E+00_dp
sys%rebatesys%MaintDisreg =  1.50000000000000000E+01_dp
sys%rebatesys%MaxCC1 =  1.35000000000000000E+02_dp
sys%rebatesys%MaxCC2 =  2.00000000000000000E+02_dp
...
sys%rebatesys%AddKid(1) =  5.27500000000000000E+01_dp
sys%rebatesys%AddKid(2) =  4.22700000000000031E+01_dp
